    ...
    <nav class="bg-light-primary border-gray-200 dark:bg-dark-primary">
        ...
        >
            <a href="https://flowbite.com/" class="flex items-center">
                <img
                    src="http://port-inertia.test/img/logo.jpg"
                    alt="ByteCode.com"
                    class="h-8 mr-3"
                />
                <span
            ...
            >
                ...
                >
                    <li>
                        <a
                            href="#"
                            class="block py-2 pl-3 pr-4 text-white bg-light-tail-500 dark:text-dark-navy-100 hover:text-light-tail-100 dark:hover:text-white"
                            aria-current="page"
                            >Home</a
                        >
                    </li>
